    ...
    handleClickDesk() {
      ...
      if (!this.isADone) {
        ...
        this.ani01("e")
          ...
          .then(() => {
            return playByLocalUrl(null, this.letterVoices["e"][1]);
          })
          .then(() => {
            return this.ani03("e");
          })
      ...
      if (!this.isBDone) {
        ...
        this.ani01("f")
          ...
          .then(() => {
            return playByLocalUrl(null, this.letterVoices["f"][1]);
          })
          .then(() => {
            return this.ani03("f");
          })
      ...
      if (!this.isCDone) {
        ...
        this.ani01("g")
          ...
          .then(() => {
            return playByLocalUrl(null, this.letterVoices["g"][1]);
          })
          .then(() => {
            return this.ani03("g");
          })
      ...
      if (this.isABCDone && !this.pointToADone) {
        // alert("a");
        this.ani05("e").then(() => {
      ...
      if (this.isABCDone && !this.pointToBDone) {
        // alert("a");
        this.ani05("f").then(() => {
      ...
      if (this.isABCDone && !this.pointToCDone) {
        // alert("a");
        this.ani05("g").then(() => {
          this.pointToCDone = true;
        });
        return;
      }
